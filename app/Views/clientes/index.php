    ...
    <section class="relative">
        ...
        <div class="max-w-4xl mx-auto my-16 px-6 py-2 rounded-lg bg-white">
            ...
            <p class="mt-4 text-gray-600 text-xl font-Outfit text-justify">
                Soy una estilista apasionada por el cuidado de los pies, porque sé que cuando nuestros pies están bien, todo nuestro cuerpo lo siente. Disfruto ayudar a mis clientes a aliviar sus molestias, brindándoles no solo bienestar físico, sino también un momento de relajación y cuidado personal. Cada sesión es más que un tratamiento; es una oportunidad para que se sientan mejor, más ligeros y renovados. Mi compromiso es ofrecer un servicio cálido y personalizado, donde cada persona sepa que sus pies están en las mejores manos.
            </p>
        </div>
        ...
        <div class="max-w-7xl mx-auto my-16 px-6 font-Outfit">
            ...
            <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php
                $recomendaciones = [
                    ['lavar_pies.jpg', '1. Lavar los pies con agua y jabón, prestando especial atención entre los dedos.'],
                    ['secar_pies.jpg', '2. Secar bien los pies, incluyendo los espacios entre los dedos.'],
                    ['cortar_unas.jpg', '3. Cortar las uñas de forma cuadrada para evitar que se encarnen en los laterales.'],
                    ['limar.jpg', '4. Limarlas correctamente para darles una forma adecuada.'],
                    ['crema.jpg', '5. Aplicar crema hidratante para evitar la resequedad y las grietas en la piel.'],
                    ['calzado.jpg', '6. Usar calzado cómodo que no apriete los dedos para prevenir uñas encarnadas.'],
                    ['acudir.jpg', '7. Acudir a un profesional para una pedicura adecuada o en caso de cambios en la coloración de las uñas, ya que esto podría indicar la presencia de hongos o bacterias.'],
                ];

                foreach ($recomendaciones as $reco) :
                ?>
                    <div class="bg-white p-5 rounded-xl shadow-md text-center border border-[#0F97A6]">
                        <img src="<?= base_url(RECURSOS_IMG . '/' . $reco[0]) ?>" alt="<?= $reco[1] ?>" class="w-90 h-80 mx-auto mb-4 rounded-lg object-cover">
                        <p class="text-gray-600 font-semibold"><?= $reco[1] ?></p>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
